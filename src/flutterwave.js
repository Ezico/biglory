  ...
  (function (t) {
    ...
    (B.allcontentloaded = function (t) {
      ...
      clearTimeout(P),
        (A = "loaded"),
        E || T(),
        t.source.postMessage({ name: "clickreport", time: _ }, t.origin),
        k &&
      ...
      (B.charge_complete = function (t) {
        (C = !1),
          d && d.chargecomplete && d.chargecomplete(t.data.type, t.data.data);
      }),
            ...
            d &&
              (g = setTimeout(function () {
                ...
                if (n) {
                  ...
                  return void (t.location.href = parseRedirectUrl(
                    n +
                      i +
                      "status=" +
                      a +
      ...
      S.addEventListener(
        "message",
        function (t) {
          t && t.data && t.data.name && B[t.data.name] && B[t.data.name](t);
        },
        !1
      );
    var R,
