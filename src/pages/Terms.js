  ...
  return (
    <div className="inner">
      ...
      <div className="information">
        ...
        <br /> This website is operated by numbergame. Throughout the site, the
        terms “we”, “us” and “our” refer to numbergame. numbergame offers this
        ...
        merchants, and/ or contributors of content. <br /> <br /> Please read
        these Terms of Service carefully before accessing or using our website.
        ...
        acceptance of those changes. <br /> <br /> Our store is hosted on
        Shopify Inc. They provide us with the online e-commerce platform that
        allows us to sell our products and Services to you. <br /> <br />{" "}
        <strong>SECTION 1 - ONLINE STORE TERMS</strong> <br /> By agreeing to
        these Terms of Service, you represent that you are at least the age of
        ...
        nature. <br /> A breach or violation of any of the Terms will result in
        an immediate termination of your Services. <br /> <br />{" "}
        <strong>SECTION 2 - GENERAL CONDITIONS</strong> <br /> We reserve the
        right to refuse Service to anyone for any reason at any time. <br /> You
        ...
        is always encrypted during transfer over networks. <br /> You agree not
        ...
        written permission by us. <br /> The headings used in this agreement are
        ...
        reliance on the material on this site is at your own risk. <br /> This
        ...
        that it is your responsibility to monitor changes to our site. <br />{" "}
        <br />{" "}
        ...
        [LINK TO REFUND POLICY] <br /> We have made every effort to display as
        accurately as possible the colors and images of our products that appear
        at the store. We cannot guarantee that your computer monitor's display
        of any color will be accurate. <br /> We reserve the right, but are not
        ...
        void where prohibited. <br /> We do not warrant that the quality of any
        ...
        by dealers, resellers or distributors. <br /> <br /> You agree to
        provide current, complete and accurate purchase and account information
        for all purchases made at our store. You agree to promptly update your
        ...
        transactions and contact you as needed. <br /> <br /> For more details,
        please review our Refund Policy: [LINK TO REFUND POLICY] <br /> <br />{" "}
        <strong>SECTION 7 - OPTIONAL TOOLS</strong> <br /> We may provide you
        with access to third-party tools over which we neither monitor nor have
        any control nor input. <br /> You acknowledge and agree that we provide
        ...
        use of optional third-party tools. <br /> Any use by you of the optional
        tools offered through the site is entirely at your own risk and
        discretion and you should ensure that you are familiar with and approve
        ...
        to these Terms of Service. <br /> <br />{" "}
        <strong>SECTION 8 - THIRD-PARTY LINKS</strong> <br /> Certain content,
        products and Services available via our Service may include materials
        from third-parties. <br /> Third-party links on this site may direct you
        to third-party websites that are not affiliated with us. We are not
        responsible for examining or evaluating the content or accuracy and we
        ...
        or Services of third-parties. <br /> We are not liable for any harm or
        ...
        third-party products should be directed to the third-party. <br />{" "}
        <br />{" "}
        <strong>
        ...
        Terms of Service. <br /> You agree that your comments will not violate
        ...
        our Privacy Policy, which can be viewed here: [LINK TO PRIVACY POLICY]{" "}
        <br /> <br />{" "}
        ...
        (including after you have submitted your order). <br /> We undertake no
        ...
        modified or updated. <br /> <br />{" "}
        <strong>SECTION 12 - PROHIBITED USES</strong> <br /> In addition to
        ...
        Service will be uninterrupted, timely, secure or error-free. <br /> We
        do not warrant that the results that may be obtained from the use of the
        Service will be accurate or reliable. <br /> You agree that from time to
        time we may remove the Service for indefinite periods of time or cancel
        the Service at any time, without notice to you. <br /> You expressly
        agree that your use of, or inability to use, the Service is at your sole
        risk. The Service and all products and Services delivered to you through
        ...
        non-infringement. <br /> In no case shall numbergame, our directors,
        ...
        indemnify, defend and hold harmless numbergame and our parent,
        ...
        a third-party. <br /> <br /> <strong>SECTION 15 - SEVERABILITY</strong>{" "}
        <br /> In the event that any provision of these Terms of Service is
        ...
        <strong>SECTION 16 - TERMINATION</strong> <br /> The obligations and
        liabilities of the parties incurred prior to the termination date shall
        survive the termination of this agreement for all purposes. <br /> These
        Terms of Service are effective unless and until terminated by either you
        or us. You may terminate these Terms of Service at any time by notifying
        us that you no longer wish to use our Services, or when you cease using
        our site. <br /> If in our sole judgment you fail, or we suspect that
        ...
        <strong>SECTION 17 - ENTIRE AGREEMENT</strong> <br /> The failure of us
        to exercise or enforce any right or provision of these Terms of Service
        shall not constitute a waiver of such right or provision. <br /> These
        ...
        and understanding between you and us and governs your use of the
        ...
        Service). <br /> Any ambiguities in the interpretation of these Terms of
        Service shall not be construed against the drafting party. <br /> <br />{" "}
        <strong>SECTION 18 - GOVERNING LAW</strong> <br /> These Terms of
        Service and any separate agreements whereby we provide you Services
        shall be governed by and construed in accordance with the laws of New
        Zealand. <br /> <br />{" "}
        <strong>SECTION 19 - CHANGES TO TERMS OF SERVICE</strong> <br /> You can
        review the most current version of the Terms of Service at any time at
        this page. <br /> We reserve the right, at our sole discretion, to
        ...
        the Terms of Service should be sent to us at contact@iedigitals.com.{" "}
        <br /> Our contact information is posted below: <br /> [INSERT TRADING
        NAME] <br /> contact@iedigitals.com <br /> [INSERT BUSINESS ADDRESS]{" "}
