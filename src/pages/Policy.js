  ...
  return (
    <div className="inner">
      ...
      <div className="information">
        <p>
          This Privacy Policy describes how numbergame.myshopify.com (the “Site”
        ...
        <p>
          ...
          complaint, please contact us by e-mail at contact@iedigitals.com or by
          mail using the details provided below:
        </p>
        <p>
          35 Uniport road,, Ozuoba, NTL, Port Harcourt (PH) 510001, New Zealand
        </p>
        ...
        <ul>
          ...
          <ul>
            ...
            <li>
              <strong>Personal Information collected:</strong> version of web
          ...
          <ul>
            ...
            <li>
              ...
              card numbers <i>[INSERT ANY OTHER PAYMENT TYPES ACCEPTED]</i>),
        ...
        <p>
          <i>[INSERT FOLLOWING SECTION IF AGE RESTRICTION IS REQUIRED]</i>
        </p>
        <h2>Minors</h2>
        <p>
        ...
        <ul>
          ...
          <li>
            <i>[INSERT INFORMATION ABOUT OTHER SERVICE PROVIDERS]</i>
          </li>
        </ul>
        <p>
          <i>
        ...
        <ul>
          <li>
            <i>[INSERT IF APPLICABLE]</i> We use Google Analytics to help us
          ...
          <li>
            <i>[INSERT IF USING SHOPIFY AUDIENCES]</i> We use Shopify Audiences
            to help us show ads on other websites with our advertising partners
            to buyers who made purchases with other Shopify merchants and who
            may also be interested in what we have to offer. We also share
            information about your use of the Site, your purchases, and the
            email address associated with your purchases with Shopify Audiences,
            through which other Shopify merchants may make offers you may be
            interested in.
          </li>
          <li>
            <i>[INSERT OTHER ADVERTISING SERVICES USED]</i>
          </li>
        </ul>
        <p>
        ...
        <p>
          <i>[INCLUDE ALL THAT APPLY TO YOUR BUSINESS]</i>
        </p>
        <ul>
          <li>Your consent;</li>
        ...
        <ul>
          <li>
            <i>categories of information sold;</i>
          </li>
          <li>
            <i>
          ...
          <li>
            <i>instructions on how to opt-out of sale;</i>
          </li>
          <li>
            <i>
        ...
        <p>
          <i>[INSERT OTHER COOKIES OR TRACKING TECHNOLOGIES THAT YOU USE]</i>
        </p>
        <p>
        ...
        <p>
          ...
          our supervisory authority here:{" "}
          <i>
            [Add contact information or website for the data protection
            authority in your jurisdiction. For example:{" "}
